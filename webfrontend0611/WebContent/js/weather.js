...
$(function() {
	//요청 주소 만들기
	var addr = 'http://api.openweathermap.org/data/2.5/weather?q=mokpo&APPID=8cb79fa7fc8457f9fc0c7c59625471a1';
	//로딩 이미지 출력
	...
	$.ajax({
		...
		success : function(result) {
			...
			$(".temp_max").html(
					'최고기온:' + parseInt((temp_max - 273.15)) + '&deg;');
			$(".temp_min").html(
					'최고기온:' + parseInt((temp_min - 273.15)) + '&deg;');
			//로딩 이미지 숨김
